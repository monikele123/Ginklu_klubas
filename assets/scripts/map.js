...
function init() {
  ...
  var mapOptions = {
      ...
      center: new google.maps.LatLng(54.909599, 24.003101), // New York

      // How you would like to style the map. 
      // This is where you would paste any style found on Snazzy Maps.
      styles: [{"featureType":"all","elementType":"labels.text.fill","stylers":[{"saturation":36},
      {"color":"#000000"},{"lightness":40}]},{"featureType":"all","elementType":"labels.text.stroke",
      ...
      {"lightness":17}]},{"featureType":"road.highway","elementType":"geometry.stroke",
  ...
  var marker = new google.maps.Marker({
      position: new google.maps.LatLng(54.909599, 24.003101),
      map: map,
      title: 'Snazzy!'
  });
}